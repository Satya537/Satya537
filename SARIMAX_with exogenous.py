...
model = SARIMAX(train['total'], exog = train[['holiday']], order = (0,0,1), seasonal_order = (1,0,1,7), enforce_invertibility = False)
...
model = SARIMAX(df1['total'], exog = df1[['holiday']], order = (0,0,1), seasonal_order = (1,0,1,7), enforce_invertibility = False)

results = model.fit()

exog_forecast = df[478:][['holiday']] #future holiday schedule
